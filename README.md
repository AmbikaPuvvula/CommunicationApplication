...
1. Proper project folder structure and meaningful file name - 5 Marks
...
2. upload project-part1.zip folder in classroom or share github link
3. use static data
4. Minimum 80% UI should same as wireframe
5. Share page is optional
